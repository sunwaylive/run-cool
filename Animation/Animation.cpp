...
// CAnimationApp 自定义加载/保存方法

void CAnimationApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CAnimationApp::LoadCustomState()
{
}

void CAnimationApp::SaveCustomState()
{
}
